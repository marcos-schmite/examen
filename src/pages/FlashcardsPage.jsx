...
export default function FlashcardsPage() {
  ...
  if (loading) {
    return (
      <div style={{ height: '100vh', width: '100vw', backgroundColor: '#09090b', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff' }}>
        <p style={{ fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '2px' }}>Cargando {subject.title}...</p>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      {/* Botón Volver */}
      <Link to="/" style={{ position: 'absolute', top: '16px', left: '16px', zIndex: 50, color: '#fff', display: 'flex', alignItems: 'center', gap: '4px', textDecoration: 'none' }}>
        <ArrowLeft size={20} />
      </Link>
